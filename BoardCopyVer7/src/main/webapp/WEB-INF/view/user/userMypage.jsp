...
<div>
	<form action="mypage" method="post" enctype="multipart/form-data"><!--  enctype="multipart/form-data" -->
		이미지변경 : <input type="file" name="profileImg" accept="image/*"> <!-- accept="image/*이미지파일만 -->
